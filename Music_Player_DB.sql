...
INSERT INTO `users` VALUES (1,'Guven','12345'),(2,'aa','11');
...
CREATE TABLE `videos` (
  ...
  CONSTRAINT `videos_ibfk_1` FOREIGN KEY (`artist_id`) REFERENCES `artists` (`artist_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-10-30  9:37:08
